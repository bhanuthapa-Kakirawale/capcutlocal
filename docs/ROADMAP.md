...
- **Gate:** importing 20 mixed files keeps the UI at 60 fps (performance trace). Each poster appears within 2 s. Cancelling any job leaves no FFmpeg process and no partial file. Killing the app mid-proxy leaves no orphan process.
